...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-taskflow-secret-key-change-in-production')
...
CELERY_BEAT_SCHEDULE = {
    'check-upcoming-deadlines-every-hour': {
        'task': 'jobs.tasks.check_upcoming_deadlines_task',
        'schedule': 3600.0,
    },
}
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Taskflow API',
    'DESCRIPTION': 'Enterprise Task and Job Workflow Management REST API',
    'VERSION': '1.0.0',
